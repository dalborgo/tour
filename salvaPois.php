...
$res = query("SELECT nick, guadagno, a.tappa, categoria, a.nome, id  FROM `tt_granpremi` b LEFT JOIN tt_dati a ON b.id = a.id_torneo AND b.tappa = a.tappa  WHERE b.tappa='$tappa' order by a.id_torneo, guadagno desc");
$out=array();
$alta = array(15,8,5);
$media=array(7,3);
$bassa=array(4,2);
